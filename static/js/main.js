...
function webSocketOnMessage(event){
    ...
    console.log("Getting message ready", action);
...
var messsageInput = document.querySelector('#msg');

btnSendMsg.addEventListener('click', sendMsgOnClick);

function sendMsgOnClick(){
    var message = messsageInput.value;
...
function createOfferer(peerUsername, receiver_channel_name){
    var peer = new RTCPeerConnection(null); // for local connections only
...
function createAnswerer(offer, peerUsername, receiver_channel_name){
    ...
    peer.addEventListener('iceconnectionstatechange', ()=>{
        ...
        //print("Ice Con State: ", iceConnectionState);
